    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1706715201231-b703e7df3395?w=1920&q=80')`,
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1765444034496-5f23e108d810?w=800&q=80')`,
            ...
            <div className="relative hidden lg:block">
              <div className="relative">
                ...
                <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl p-4 border border-white/20 shadow-2xl transform rotate-3 hover:rotate-0 transition-all duration-500">
                  <img 
                    src="https://images.unsplash.com/photo-1567230594460-36c35af65bb0?w=600&q=80" 
                    alt="Indian Worker"
      ...
      <section className="py-24 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1764116858643-8519de606248?w=1920&q=80')`,
